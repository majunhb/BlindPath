...
class CoroutineExceptionHandler(
    ...
    override val key = kotlin.coroutines.CoroutineExceptionHandler.Key
    ...
    companion object {
         ...
         * 创建一个协程异常处理器
         */
        fun create(onError: (Throwable) -> Unit = {}): CoroutineExceptionHandler {
            return CoroutineExceptionHandler(onError)
        }
    }
}
